    ...
    <ScrollView width="100%" backgroundColor='#eee'>
      <Center>
        <Box w='100%' padding='3' marginTop={-3}>
          ...
          <CampoNumero title={"Número da certidão de Nascimento Filho(a):"} value={numeroCertidaoFilho} onChangeText={setnumeroCertidaoFilho} type={'cpf'} />
          ...
          <Actionsheet isOpen={isOpen} onClose={onClose}>
            <Actionsheet.Content _dragIndicator={{
              ...
              <Actionsheet.Item>●  RG e CPF do segurado (frente e verso)</Actionsheet.Item>
              <Actionsheet.Item>●  Certidão de nascimento do(a) filho(a) atualizada (expedida até 90 dias).</Actionsheet.Item>
