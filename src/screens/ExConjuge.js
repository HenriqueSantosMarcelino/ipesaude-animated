        ...
        <Box w='100%' padding='3' marginTop={-3}>
          ...
          <Actionsheet isOpen={isOpen} onClose={onClose}>
            <Actionsheet.Content _dragIndicator={{
              ...
              <Box w="100%" h={60} px={4} justifyContent="center">
                <Text mt="3" italic bold fontSize="22" color="gray.800" _dark={{
                  color: 'gray.300'
                }}>
              ...
              <Actionsheet.Item>●  Certidão de casamento com averbação da separação ou divórcio atualizada (expedida até 90 dias);</Actionsheet.Item>
              <Actionsheet.Item mt="-2">●  Sentença judicial ou escritura pública de divórcio ou separação com a fixação de pensão alimentícia em benefício do ex-cônjuge; ou</Actionsheet.Item>
              <Actionsheet.Item mt="-2">●  RG e CPF do(a) ex-cônjuge (frente e verso)</Actionsheet.Item>
              <Actionsheet.Item mt="-2">●  Certidão de casamento atualizada (expedida até 90 dias);</Actionsheet.Item>
              <Actionsheet.Item mt="-4">●  Comprovação do efetivo recebimento da pensão alimentícia pelo(a) habilitando(a) atualizado (até 90 dias) (Ex: contracheque, Declaração de Imposto de Renda, depósito bancário, etc.)</Actionsheet.Item>
